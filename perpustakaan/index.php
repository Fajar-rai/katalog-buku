...
<body class="text-center" background="resources/perpus.jpg" background-size="cover">
    <div class="container">
        <main class="form-login">
        <form style="width:100%" class="mx-auto p-5  mt-5 align-items-center" method="post">
            <div class="card border-secondary mb-3" style="max-width: 18rem;">
            <div class="card-header h3 mb-3 fw-normal">Login</div>
