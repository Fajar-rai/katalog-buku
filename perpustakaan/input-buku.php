    ...
    <form method="post" class="mx-auto pb-5">
            <table align="center" class="display mt-2 pb-5" style="width:90%">
                ...
                <tr>
                    ...
                    <td>
                        <?php if(@$_GET['id']==""){ ?>
                                <button class="btn btn-outline-success col-6 mt-3" type="submit" name="simpan" value="SIMPAN">Simpan</button>
                            <?php }else{?>
                                <button class="btn btn-outline-success col-6 mt-3" type="submit" name="ubah" value="UBAH">Ubah</button>
                            <?php } ?>  
                    </td>
                </tr>
            </table>
            ...
            <table align="center" border="1" id="tabel-data" class="display mt-5" style="width:90%">
                ...
                <tbody>    
                    ...
                    <tr>
                        ...
                        <td><button type="submit" class="btn btn-outline-danger"><a style="text-decoration:none; color:black" href="?menu=dashboard&hapus&id=<?php echo $r['id_buku'] ?>" onclick="return confirm('Hapus Data?')">Hapus</a></button></td>
                        <td><button type="submit" class="btn btn-link"><a style="text-decoration:none; color:blue; hover" href="?menu=dashboard&edit&id=<?php echo $r['id_buku'] ?>">Edit</a></button></td>                
                    </tr>
                    <?php }  } ?>
                </tbody>
            </table>
